        ...
        <div className="login-header" style={{ marginBottom: '1.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
            <svg width="64" height="55" viewBox="0 0 871 750" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path fill="#6EE7B7" d="M518.266 141.932C521.706 141.953 528.577 141.453 531.256 143.372C525.629 144.269 520.661 144.639 515.974 148.084L515.624 147.129C516.026 145.227 517.222 143.622 518.266 141.932Z"/>
            </svg>
          </div>
